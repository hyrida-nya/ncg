...
db.serialize(() => {
    ...
    db.run("CREATE TABLE rooms (id INTEGER PRIMARY KEY, name TEXT UNIQUE, description TEXT, owner_id INTEGER, join_policy TEXT DEFAULT 'public', FOREIGN KEY(owner_id) REFERENCES users(id))");
